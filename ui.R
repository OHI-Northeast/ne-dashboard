...
### Side bar tabs
  ...
  tabItems(
    ...
    tabItem(tabName = "welcome",
        ...
        fluidRow(
          tags$div(href="#shiny-tab-cw", "data-toggle" = "tab",
                   infoBox("Clean Waters", 
                           ...
                           fill = TRUE, 
                           width = 3)),
          tags$div(href="#shiny-tab-fp", "data-toggle" = "tab",
                  infoBox("Food Provision",
                          ...
                          fill = TRUE, 
                          width = 3)),
          tags$div(href="#shiny-tab-liveco", "data-toggle" = "tab",
                  infoBox("Livelihoods & Economies", 
                          ...
                          fill = TRUE, 
                          width = 3)),
          tags$div(href="#shiny-tab-tr", "data-toggle" = "tab",
                  infoBox("Tourism & Recreation", 
        ...
        fluidRow(
          tags$div(href="#shiny-tab-bio", "data-toggle" = "tab",
                  infoBox("Biodiversity", 
                          ...
                          fill = TRUE, 
                          width = 3)),
          tags$div(href="#shiny-tab-sop", "data-toggle" = "tab",
                  infoBox("Sense of Place", 
                          ...
                          fill = TRUE, 
                          width = 3)),
          tags$div(href="#shiny-tab-rao", "data-toggle" = "tab",
                  infoBox("Resource Access Opportunities", 
                          ...
                          fill = TRUE, 
                          width = 3)),
          tags$div(href="#shiny-tab-hs", "data-toggle" = "tab",
                  infoBox("Habitat Services", 
